    ...
    const columns = [
      ...
      },
      {
        title: this.props.intl.formatMessage({
          ...
          description:
            'Column title text for model version in model version table'
        }),
      ...
      },
      {
        title: this.props.intl.formatMessage({
          ...
          description:
            'Column title text for created at timestamp in model version table'
        }),
        dataIndex: 'creation_timestamp',
        render: creationTimestamp => (
          <span>{Utils.formatTimestamp(creationTimestamp)}</span>
        ),
      ...
      },
      {
        title: this.props.intl.formatMessage({
          ...
          description:
            'Column title text for creator username in model version table'
        }),
        dataIndex: 'user_id'
      },
      {
        title: this.props.intl.formatMessage({
          ...
          description:
            'Column title text for model version stage in model version table'
        }),
      ...
      },
      {
        title: this.props.intl.formatMessage({
          ...
          description:
            'Column title text for description in model version table'
        }),
